...
if (isset($_SESSION["id"]) != 0) {
    ...
    function deleteRecipe($recipeID, $userID, $conn)
    {  //for deleting of the recipe from db                                               
    ...
    function deleteComments($recipeID, $conn)
    { //for deleting of the comments from db
    ...
    function deleteRatings($recipeID, $userID, $conn)
    { //for deleting of the ratings from db
    ...
    function deleteImages($recipeID, $userID, $conn)
    {  //for deleting of the images from db
